...
app.secret_key = 'pseudonmos'


# function to turn credentials to json dictionary
...
# function to create percentages for the pie charts
...
# second page - user selects feature
...
# clear credentials from flask session
@app.route('/clear')
